...
const AccordionItemContainer = ({ children, title, mt, px }) => {
  ...
  return (
    <div className={`overflow-hidden rounded-md shadow-sm shadow-gray-400 dark:shadow-gray-400 dark:bg-[#1b1a1c] bg-customWhite transition-all ease-in-out duration-300  w-full ${mt}`}>
      <h2
